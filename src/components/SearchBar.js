...
export default function SearchBar() {
	...
	return (
		<div className="flex items-center justify-center w-full h-1/6 bg-blue-200">
				<input className="w-2/4 h-10 px-8 py-6 rounded-xl outline-none shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" type="search" placeholder="Search" id="search-bar"></input>
                <button onClick={() => {
